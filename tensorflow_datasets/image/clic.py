...
print(_CITATION)
_DESCRIPTION = """
CLIC is a dataset for the Challenge on Learned Image Compression 2020. These
images contain a mix of the professional and mobile datasets and are used to
train and benchmark rate-distortion performance.
"""
  ...
  def _info(self):
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            'image_path': tfds.features.Image(),
        }),
